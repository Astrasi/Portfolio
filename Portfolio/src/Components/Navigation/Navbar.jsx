  ...
  return (
    <div className='navbar'>
      ...
      <ul ref={menRef} className='nav-menu'>
        ...
        <li><AnchorLink className='anchor-link' href='#about'><p onClick={()=>setMenu("about")}>A Propos de Moi</p></AnchorLink> {menu==="about"?<img src={underline} alt=''/>:<></>} </li>
      ...
      <div className='nav-connect'><AnchorLink className='anchor-link' href='#contact'>Connectez avec Moi</AnchorLink></div>
    </div> 
  )
}
